...
//            if (_showNavigationBottomLine) {
                [self setShowNavigationBottomLine:YES];
//            }else{
//                [self setShowNavigationBottomLine:NO];
//            }
...
- (void)setShowNavigationBottomLine:(BOOL)showNavigationBottomLine {
    _showNavigationBottomLine = showNavigationBottomLine;
     UIView * line = [[UIView alloc]initWithFrame:CGRectMake(0, kNavHeight-0.5, UIWidth, 0.5)];
...
- (UIButton *)rightButton {
    if (!_rightButton) {
        ...
        CGFloat minX = [UIScreen mainScreen].bounds.size.width - 44 - Adaptive(20);
