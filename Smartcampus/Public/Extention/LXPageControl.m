...
- (void)setupPageControl {
    for (int i = 0; i < itemsCount; i++) {
        ...
        [btn setBackgroundImage:self.unselectedImage ? self.unselectedImage : [UIImage getImageWithColor:self.unselectedColor] forState:UIControlStateNormal];
        [btn setBackgroundImage:self.selectedImage ? self.selectedImage : [UIImage getImageWithColor:self.selectedColor] forState:UIControlStateSelected];
