...
//    self.calendarHeader.dateStr = [NSString stringWithFormat:@"%ld年%ld月",monthModel.year,monthModel.month];
    self.calendarHeader.dateStr = [NSString stringWithFormat:@"%ld月",monthModel.month];
...
-(UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        _collectionView =[[UICollectionView alloc]initWithFrame:CGRectMake(0, 40, self.lx_width, 6 * 50) collectionViewLayout:flow];
